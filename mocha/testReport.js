...
var genePool_ = [
  { archon: { organs: { dna:  { avoidanceFactor: -0.861784016767024, massOfMyBabies: 0.50716979793855, embryoThreshold: 4750.055073942050,
   ...
   { archon: { organs: { dna: { avoidanceFactor: -0.872749172963119, massOfMyBabies: 0.528383153584622, embryoThreshold: 4278.72384010006,
   ...
   { archon: { organs: { dna: { avoidanceFactor: -0.891209140334782, massOfMyBabies: 0.50638624395492, embryoThreshold: 4536.36191240416,
...
describe('Report', function() {
  it('Should not barf on re-use', function() {
    genePool.genePool_ = genePool_.slice(0);
    var r = new Rob.Report(genePool);
    report.reportAsJson();
    report.reportAsJson();
  });
...
// Not so much a test as a way of making sure the report looks nice
/*genePool.genePool_ = genePool_.slice(0);
var report = null;

report = new Rob.Report(genePool);
report.reportAsText(42);*/
